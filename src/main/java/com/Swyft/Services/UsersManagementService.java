...
import com.Swyft.Security.JWTAuthFilter;
...
public class UsersManagementService {
    ...
    public RequestDTO register(RequestDTO registrationRequest){
    ...
    public RequestDTO getUsersById(Integer id) {
        RequestDTO reqRes = new RequestDTO();
        try {
    ...
    public RequestDTO deleteUser(Integer userId) {
        RequestDTO reqRes = new RequestDTO();
        try {
    ...
    public RequestDTO updateUser(Integer userId, OurUsers updatedUser) {
        RequestDTO reqRes = new RequestDTO();
        try {
            Optional<OurUsers> userOptional = userRepository.findById(userId);
            if (userOptional.isPresent()) {
    ...
    public RequestDTO getMyInfo(String email){
        RequestDTO reqRes = new RequestDTO();
        try {
